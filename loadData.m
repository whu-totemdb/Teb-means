function [Data_ori, gt, c] = loadData(data, dataset_name, max_points,cluse_num)
     ...
     switch data
       ...
       case 'yale-b'
         ...
         case 'census1990_500000'
             X = csvread('D:\BalanceKMeams\k-means\Code\Data\individually-fair-k-clustering-main\individually-fair-k-clustering-main\yelp\output\census1990_500000_[20].csv',1,1)';
...
% datasets = {'athlete', 'bank', 'census', 'creditcard', 'diabetes', 'recruitment', 'Spanish','yelp_academic_dataset_business'};
         ...
         case 'Balance_EXP'
%              file_path =strcat("D:\BalanceKMeams\k-means\Code\Data\individually-fair-k-clustering-main\individually-fair-k-clustering-main\yelp\output\", dataset_name, "_1000_", num2str(cluse_num), ".csv");
%              file_path =strcat("D:\BalanceKMeams\k-means\Code\Data\individually-fair-k-clustering-main\individually-fair-k-clustering-main\yelp\output\Bigdata\", dataset_name, "_", num2str(max_points), "_", num2str(cluse_num), ".csv");
             file_path =strcat("D:\BalanceKMeams\k-means\Code\Data\individually-fair-k-clustering-main\individually-fair-k-clustering-main\yelp\output\", dataset_name, "_", num2str(max_points), "_", num2str(cluse_num), ".csv");
